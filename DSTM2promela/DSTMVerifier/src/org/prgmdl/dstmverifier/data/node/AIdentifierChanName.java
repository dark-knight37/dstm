...
public final class AIdentifierChanName extends PChanName
{
    private PUnique _unique_;

    public AIdentifierChanName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIdentifierChanName(
            cloneNode(this._unique_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAIdentifierChanName(this);
    }
