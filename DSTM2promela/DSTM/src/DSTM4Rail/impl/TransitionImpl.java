...
public class TransitionImpl extends NamedElementImpl implements Transition {
	...
	public EList<String> getActions() {
		if (actions == null) {
			actions = new EDataTypeEList<String>(String.class, this, DSTM4RailPackage.TRANSITION__ACTIONS);
		}
		return actions;
	}
	...
	public EList<String> getPar_instantiation() {
		if (par_instantiation == null) {
			par_instantiation = new EDataTypeEList<String>(String.class, this, DSTM4RailPackage.TRANSITION__PAR_INSTANTIATION);
		}
