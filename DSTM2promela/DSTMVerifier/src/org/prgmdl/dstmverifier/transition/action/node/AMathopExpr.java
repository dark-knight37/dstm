...
public final class AMathopExpr extends PExpr
{
    private TLPar _lPar_;
    private PFirst _first_;
    private PMbop _mbop_;
    ...
    public AMathopExpr(
        ...
        @SuppressWarnings("hiding") PMbop _mbop_,
    ...
    public Object clone()
    {
        return new AMathopExpr(
            cloneNode(this._lPar_),
            cloneNode(this._first_),
            cloneNode(this._mbop_),
    ...
    {
        ((Analysis) sw).caseAMathopExpr(this);
    }
    ...
    public PMbop getMbop()
    {
        return this._mbop_;
    }

    public void setMbop(PMbop node)
    {
        if(this._mbop_ != null)
        {
            this._mbop_.parent(null);
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._mbop_ == oldChild)
        {
            setMbop((PMbop) newChild);
            return;
        }
