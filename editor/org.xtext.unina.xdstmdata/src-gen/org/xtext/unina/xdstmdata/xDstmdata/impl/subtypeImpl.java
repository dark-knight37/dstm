 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.unina.xdstmdata.xDstmdata.impl.subtypeImpl#getTString <em>TString</em>}</li>
 *   <li>{@link org.xtext.unina.xdstmdata.xDstmdata.impl.subtypeImpl#getTChn <em>TChn</em>}</li>
 *   <li>{@link org.xtext.unina.xdstmdata.xDstmdata.impl.subtypeImpl#getTID <em>TID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class subtypeImpl extends MinimalEObjectImpl.Container implements subtype
{
  ...
  {
    return XDstmdataPackage.Literals.SUBTYPE;
  }
  ...
  public void setTString(String newTString)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XDstmdataPackage.SUBTYPE__TSTRING, oldTString, tString));
  }
  ...
  public NotificationChain basicSetTChn(channel_specifier newTChn, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDstmdataPackage.SUBTYPE__TCHN, oldTChn, newTChn);
  ...
  public void setTChn(channel_specifier newTChn)
  {
    if (newTChn != tChn)
    {
      ...
      if (tChn != null)
        msgs = ((InternalEObject)tChn).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDstmdataPackage.SUBTYPE__TCHN, null, msgs);
      if (newTChn != null)
        msgs = ((InternalEObject)newTChn).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDstmdataPackage.SUBTYPE__TCHN, null, msgs);
      msgs = basicSetTChn(newTChn, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XDstmdataPackage.SUBTYPE__TCHN, newTChn, newTChn));
  }
  ...
  public void setTID(String newTID)
  {
    ...
    tID = newTID;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XDstmdataPackage.SUBTYPE__TID, oldTID, tID));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XDstmdataPackage.SUBTYPE__TCHN:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XDstmdataPackage.SUBTYPE__TSTRING:
        return getTString();
      case XDstmdataPackage.SUBTYPE__TCHN:
        return getTChn();
      case XDstmdataPackage.SUBTYPE__TID:
        return getTID();
    }
