 ...
 * @generated
 */
public class PromelammSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PromelammPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.PROCESS: {
				promelamm.Process process = (promelamm.Process)theEObject;
				T result = caseProcess(process);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.VARIABLE: {
				Variable variable = (Variable)theEObject;
				T result = caseVariable(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.ENUMERATION: {
				Enumeration enumeration = (Enumeration)theEObject;
				T result = caseEnumeration(enumeration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.PRIMITIVE: {
				Primitive primitive = (Primitive)theEObject;
				T result = casePrimitive(primitive);
				if (result == null) result = caseVariable(primitive);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.CHANNEL: {
				Channel channel = (Channel)theEObject;
				T result = caseChannel(channel);
				if (result == null) result = caseVariable(channel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.DO: {
				Do do_ = (Do)theEObject;
				T result = caseDo(do_);
				if (result == null) result = caseCompositeStatement(do_);
				if (result == null) result = caseAbstractStatement(do_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.CASE: {
				Case case_ = (Case)theEObject;
				T result = caseCase(case_);
				if (result == null) result = caseCompositeStatement(case_);
				if (result == null) result = caseAbstractStatement(case_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.UNLESS: {
				Unless unless = (Unless)theEObject;
				T result = caseUnless(unless);
				if (result == null) result = caseCompositeStatement(unless);
				if (result == null) result = caseAbstractStatement(unless);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.FOR: {
				For for_ = (For)theEObject;
				T result = caseFor(for_);
				if (result == null) result = caseCompositeStatement(for_);
				if (result == null) result = caseAbstractStatement(for_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.ARRAY: {
				Array array = (Array)theEObject;
				T result = caseArray(array);
				if (result == null) result = casePrimitive(array);
				if (result == null) result = caseVariable(array);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.IF: {
				If if_ = (If)theEObject;
				T result = caseIf(if_);
				if (result == null) result = caseCompositeStatement(if_);
				if (result == null) result = caseAbstractStatement(if_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.COMPOSITE_STATEMENT: {
				CompositeStatement compositeStatement = (CompositeStatement)theEObject;
				T result = caseCompositeStatement(compositeStatement);
				if (result == null) result = caseAbstractStatement(compositeStatement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.ABSTRACT_STATEMENT: {
				AbstractStatement abstractStatement = (AbstractStatement)theEObject;
				T result = caseAbstractStatement(abstractStatement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.SIMPLE_STATEMENT: {
				SimpleStatement simpleStatement = (SimpleStatement)theEObject;
				T result = caseSimpleStatement(simpleStatement);
				if (result == null) result = caseAbstractStatement(simpleStatement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PromelammPackage.PARAMETER: {
	 ...
	 * @generated
	 */
	public T caseProcess(promelamm.Process object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Unless</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Unless</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUnless(Unless object) {
		return null;
	}
