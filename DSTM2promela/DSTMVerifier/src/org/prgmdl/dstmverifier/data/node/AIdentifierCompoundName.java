...
public final class AIdentifierCompoundName extends PCompoundName
{
    private PUnique _unique_;

    public AIdentifierCompoundName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIdentifierCompoundName(
            cloneNode(this._unique_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAIdentifierCompoundName(this);
    }
